...
!function(a, b, c, d) {
    ...
    function e(b, c, f) {
        ...
        c.sortToPreventGaps !== d && (c.sortByDimension = c.sortToPreventGaps,
        ...
        g.$obj.addClass("cbp"),
        (0 === h.length || h.first().hasClass("cbp-item")) && (g.wrapInner(g.obj, "cbp-wrapper"),
            g.addedWrapp = !0),
    ...
    a.extend(e.prototype, {
            ...
            if (b = b || "",
                ...
                for (a.length === d && (a = [a]),
                    ...
                    for (e = a[f],
                             ...
                             g.setAttribute("class", b); e.childNodes.length; )
            ...
            requestAnimationFrame(function() {
                    ...
                    if (c.hasAttribute("width") && c.hasAttribute("height")) {
                        ...
                        if (null === d.checkSrc(c))
                            ...
                            e.on("load.cbp error.cbp", function() {
                                ...
                                c.srcset ? (e.attr("sizes", c.sizes || "100vw"),
                                    e.attr("srcset", c.srcset)) : e.attr("src", c.src)
                        }
                        return null
                    }
                    return d.checkSrc(c)
                ...
                return 0 === f ? void c.call(d) : void a.each(e, function(b, e) {
                    ...
                    g.on("load.cbp error.cbp", function() {
                        ...
                        e.srcset ? (g.attr("sizes", e.sizes),
                            g.attr("srcset", e.srcset)) : g.attr("src", e.src)
                })
            })
        },
        checkSrc: function(b) {
            ...
            if ("" === e)
                return null;
            var f = a("<img>");
            c ? (f.attr("sizes", b.sizes || "100vw"),
                f.attr("srcset", c)) : f.attr("src", e);
            var g = f[0];
        ...
        display: function() {
            ...
            a.width > 0 && (a.storeData(a.blocks),
        ...
        resizeEvent: function() {
            ...
            e.private.resize.initEvent({
                ...
                fn: function() {
                    ...
                    a.width !== b && (a.width = b,
                    "alignCenter" === a.options.gridAdjustment && (a.wrapper[0].style.maxWidth = ""),
                        a.layoutAndAdjustment(),
        ...
        gridAdjust: function() {
            var b = this;
            "responsive" === b.options.gridAdjustment ? b.responsiveLayout() : (b.blocks.removeAttr("style"),
        ...
        layout: function() {
            ...
            a.computeBlocks(a.filterConcat(a.defaultFilter)),
                "slider" === a.options.layoutMode ? (a.sliderLayoutReset(),
                    a.sliderLayout()) : (a.mosaicLayoutReset(),
                    a.mosaicLayout()),
                a.positionateItems(),
        ...
        responsiveLayout: function() {
            var b = this;
            b.cols = b[a.isArray(b.options.mediaQueries) ? "getColumnsBreakpoints" : "getColumnsAuto"](),
                b.columnWidth = b.columnWidthTruncate((b.width + b.options.gapVertical) / b.cols),
                b.widthAvailable = b.columnWidth * b.cols,
            "mosaic" === b.options.layoutMode && b.getMosaicWidthReference(),
                b.blocks.each(function(c, d) {
                    var e, f = a(d).data("cbp"), g = 1;
                    "mosaic" === b.options.layoutMode && (g = b.getColsMosaic(f.widthInitial)),
            ...
            b.blocks.each(function(b, d) {
                ...
                b.blocks.each(function(c, d) {
                    ...
                    e.height = g,
                        e.heightAndGap = g + b.options.gapHorizontal
                })
        },
        ...
        resizeMainContainer: function() {
            ...
            return "alignCenter" === c.options.gridAdjustment && (b = 0,
                ...
                f === c.height ? void c.triggerEvent("resizeMainContainer") : (c.obj.style.height = f + "px",
                c.height !== d && (e.private.modernBrowser ? c.$obj.one(e.private.transitionend, function() {
        ...
        triggerEvent: function(a, b) {
            ...
            if (e.registeredEvents[a])
                for (c = 0,
                         d = e.registeredEvents[a].length; c < d; c++)
                    e.registeredEvents[a][c].func.call(e, b),
                    e.registeredEvents[a][c].oneTime && (e.registeredEvents[a].splice(c, 1),
                        c--,
                        d--)
        },
        addItems: function(b, c, d) {
            ...
            f.wrapInner(b, "cbp-item-wrapper"),
                f.$ul[d](b.addClass("cbp-item-loading").css({
                    top: "100%",
                    left: 0
                })),
                ...
                f.loadImages(b, function() {
                    if (f.$obj.addClass("cbp-updateItems"),
                    "append" === d)
                        f.storeData(b, f.blocks.length),
                            a.merge(f.blocks, b);
                    else {
                        f.storeData(b);
                        var c = b.length;
                ...
                b.each(function(b, c) {
                    d.blocks.each(function(b, f) {
                        if (c === f) {
                            var g = a(f);
                            d.blocks.splice(b, 1),
                                e.private.modernBrowser ? (g.one(e.private.animationend, function() {
                                    g.remove()
                                }),
        ...
        a.fn.cubeportfolio = function(a, b, c) {
            return this.each(function() {
                ...
                if (e.public[a])
                    return e.public[a].call(this, b, c);
    ...
    function(a, b, c, d) {
        ...
        a.extend(e.prototype, {
            ...
            getSpaceIndexAndBlock: function() {
                ...
                return a.each(b.freeSpaces, function(d, e) {
                    ...
                    return b.blocksOn.each(function(b, h) {
                        var i = a(h).data("cbp");
                        if (i.pack !== !0)
                            return i.widthAndGap <= f && i.heightAndGap <= g ? (i.pack = !0,
                                c = {
                                    spaceIndex: d,
                                    dataBlock: i
                                },
                        ...
                        !b.blocksAreSorted && b.options.sortByDimension && d > 0 ? (c = null,
                            !1) : null === c && void 0
                }),
                    c
            },
            generateF1F2: function(a, b) {
                ...
                e.leftEnd > e.leftStart && e.topEnd > e.topStart && (c.freeSpaces.splice(a, 0, e),
                    a++),
            ...
            generateG1G2G3G4: function(b) {
                ...
                a.each(c.freeSpaces, function(a, e) {
                    ...
                    return null === f ? void d.push(e) : (c.generateG1(e, f, d),
                        c.generateG2(e, f, d),
                        c.generateG3(e, f, d),
                ...
                b.uniqueFreeSpaces(),
                    b.freeSpaces = a.map(b.freeSpaces, function(c, d) {
                        return a.each(b.freeSpaces, function(a, b) {
                            if (d !== a)
                                return b.leftStart <= c.leftStart && b.leftEnd >= c.leftEnd && b.topStart <= c.topStart && b.topEnd >= c.topEnd ? (c = null,
                                    !1) : void 0
                        }),
                            c
                    })
            ...
            uniqueFreeSpaces: function() {
                ...
                a.each(b.freeSpaces, function(b, d) {
                    a.each(c, function(a, b) {
                        if (b.leftStart === d.leftStart && b.leftEnd === d.leftEnd && b.topStart === d.topStart && b.topEnd === d.topEnd)
                            return d = null,
                                !1
                    }),
                    null !== d && c.push(d)
    ...
    function(a, b, c, d) {
        ...
        e.private = {
            publicEvents: function(b, c, d) {
                ...
                e.events = [],
                    e.initEvent = function(a) {
                        0 === e.events.length && e.scrollEvent(),
                            e.events.push(a)
                    }
                    ,
            ...
            checkInstance: function(b) {
                ...
                if (!c)
                    throw new Error("cubeportfolio is not initialized. Initialize it before calling " + b + " method!");
                return c.triggerEvent("publicMethod"),
                    c
            },
            browserInfo: function() {
                var a, c, f, g = e.private, h = navigator.appVersion;
                h.indexOf("MSIE 8.") !== -1 ? g.browser = "ie8" : h.indexOf("MSIE 9.") !== -1 ? g.browser = "ie9" : h.indexOf("MSIE 10.") !== -1 ? g.browser = "ie10" : b.ActiveXObject || "ActiveXObject"in b ? g.browser = "ie11" : /android/gi.test(h) ? g.browser = "android" : /iphone|ipad|ipod/gi.test(h) ? g.browser = "ios" : /chrome/gi.test(h) ? g.browser = "chrome" : g.browser = "",
                    f = g.styleSupport("perspective"),
                typeof f !== d && (a = g.styleSupport("transition"),
                    g.transitionend = {
                        WebkitTransition: "webkitTransitionEnd",
                        transition: "transitionend"
                    }[a],
            ...
            styleSupport: function(a) {
                ...
                return a in e.style ? b = a : d in e.style && (b = d),
                    e = null,
                    b
            }
        },
            e.private.browserInfo(),
            e.private.resize = new e.private.publicEvents("resize.cbp",50,function() {
                    if (b.innerHeight == screen.height)
                        return !0
                }
            )
    }(jQuery, window, document),
    function(a, b, c, d) {
        ...
        e.public = {
                ...
                if (!g.isAnimating) {
                    ...
                    a.isFunction(c) && g.registerEvent("filterFinish", c, !0),
                        ...
                        if (g.options.filterDeeplinking) {
                            ...
                            g.singlePage && g.singlePage.url && (g.singlePage.url = location.href)
                        }
                        g.defaultFilter = b,
                            f = g.filterConcat(g.defaultFilter)
                    }
            ...
            append: function(b, c) {
                ...
                return d.isAnimating || f.length < 1 ? void (a.isFunction(c) && c.call(d, f)) : (d.isAnimating = !0,
                    void (d.singlePageInline && d.singlePageInline.isOpen ? d.singlePageInline.close("promise", {
                        callback: function() {
            ...
            layout: function(b) {
                ...
                return c.width = c.$obj.outerWidth(),
                    c.isAnimating || c.width <= 0 ? void (a.isFunction(b) && b.call(c)) : ("alignCenter" === c.options.gridAdjustment && (c.wrapper[0].style.maxWidth = ""),
        ...
        a.extend(e.prototype, {
            updateSliderPagination: function() {
                ...
                if (d.options.showPagination) {
                    for (b = Math.ceil(d.blocksOn.length / d.cols),
            ...
            destroySlider: function() {
                var b = this;
                "slider" === b.options.layoutMode && (b.$obj.removeClass("cbp-mode-slider"),
            ...
            nextSlider: function(a) {
                ...
                if (b.isEndSlider()) {
                    ...
                    b.options.scrollByPage ? b.sliderActive = Math.min(b.sliderActive + b.cols, b.blocksOn.length - b.cols) : b.sliderActive += 1;
                b.goToSlider()
            },
            prevSlider: function(a) {
                ...
                if (b.isStartSlider()) {
                    ...
                    b.options.scrollByPage ? b.sliderActive = Math.max(0, b.sliderActive - b.cols) : b.sliderActive -= 1;
                b.goToSlider()
            },
            jumpToSlider: function(a) {
                var b = this
                    , c = Math.min(a.index() * b.cols, b.blocksOn.length - b.cols);
                c !== b.sliderActive && (b.sliderActive = c,
                    b.goToSlider())
            },
            jumpDragToSlider: function(a) {
                var b, c, d, e = this, f = a > 0;
                e.options.scrollByPage ? (b = e.cols * e.columnWidth,
                    c = e.cols) : (b = e.columnWidth,
                    c = 1),
                    a = Math.abs(a),
                    d = Math.floor(a / b) * c,
                a % b > 20 && (d += c),
                    f ? e.sliderActive = Math.min(e.sliderActive + d, e.blocksOn.length - e.cols) : e.sliderActive = Math.max(0, e.sliderActive - d),
                    e.goToSlider()
            },
            ...
            enableDisableNavSlider: function() {
                var a, b, c = this;
                c.isRewindNav() || (b = c.isStartSlider() ? "addClass" : "removeClass",
                    c.navPrev[b]("cbp-nav-stop"),
                    b = c.isEndSlider() ? "addClass" : "removeClass",
                    c.navNext[b]("cbp-nav-stop")),
                c.options.showPagination && (a = c.options.scrollByPage ? Math.ceil(c.sliderActive / c.cols) : c.isEndSlider() ? c.navPaginationItems.length - 1 : Math.floor(c.sliderActive / c.cols),
                    c.navPaginationItems.removeClass("cbp-nav-pagination-active").eq(a).addClass("cbp-nav-pagination-active")),
                c.customPagination && (a = c.options.scrollByPage ? Math.ceil(c.sliderActive / c.cols) : c.isEndSlider() ? c.customPaginationItems.length - 1 : Math.floor(c.sliderActive / c.cols),
                    c.customPaginationItems.removeClass(c.customPaginationClass).eq(a).addClass(c.customPaginationClass))
            },
            ...
            sliderLayout: function() {
                ...
                b.blocksOn.each(function(c, d) {
                    ...
                    e.leftNew = b.columnWidth * c,
                        e.topNew = 0,
                        b.sliderFreeSpaces.push({
                            topStart: e.heightAndGap
                        })
                }),
                    b.getFreeSpacesForSlider(),
                    b.$ul.width(b.columnWidth * b.blocksOn.length - b.options.gapVertical)
            },
            getFreeSpacesForSlider: function() {
                var a = this;
                a.freeSpaces = a.sliderFreeSpaces.slice(a.sliderActive, a.sliderActive + a.cols),
                    a.freeSpaces.sort(function(a, b) {
            ...
            updateSliderPosition: function() {
                ...
                e.private.modernBrowser ? a.$ul[0].style[e.private.transform] = "translate3d(" + b + "px, 0px, 0)" : a.$ul[0].style.left = b + "px",
            ...
            dragSlider: function() {
                ...
                function g(a) {
                    q.$obj.removeClass("cbp-mode-slider-dragStart"),
                        s = !0,
                        0 !== l ? (m.one("click.cbp", function(a) {
                            return !1
                        }),
                            requestAnimationFrame(function() {
                ...
                function h(a) {
                    ...
                    (l > 8 || l < -8) && a.preventDefault(),
                        q.isDrag = !0;
                    var b = n - l;
                    l < 0 && l < n ? b = (n - l) / 5 : l > 0 && n - l < -o && (b = -o + (o + n - l) / 5),
                        e.private.modernBrowser ? q.$ul[0].style[e.private.transform] = "translate3d(" + b + "px, 0px, 0)" : q.$ul[0].style.left = b + "px"
                }
                function i() {
                    if (s = !1,
                        q.isDrag = !1,
                ...
                q.isDrag = !1,
                    "ontouchstart"in b || navigator.maxTouchPoints > 0 || navigator.msMaxTouchPoints > 0 ? (t = {
...
"function" != typeof Object.create && (Object.create = function(a) {
    ...
    function() {
        for (var a = 0, b = ["moz", "webkit"], c = 0; c < b.length && !window.requestAnimationFrame; c++)
        ...
        e.prototype.filterLayout = function() {
            ...
            c.$obj.addClass("cbp-animation-" + c.options.animationType),
                ...
                c.blocksOff2On = c.blocksOn.filter(".cbp-item-off").removeClass("cbp-item-off").addClass("cbp-item-off2on").each(function(b, c) {
                    var d = a(c).data("cbp");
                    c.style.left = d.leftNew + "px",
                        c.style.top = d.topNew + "px"
                }),
    ...
    function(a, b, c, d) {
        ...
        e.prototype.filterLayout = function() {
            function b() {
                ...
                "sequentially" === c.options.animationType && c.blocksOn.each(function(b, c) {
                ...
                requestAnimationFrame(function() {
                    c.$obj.addClass("cbp-animation-" + c.options.animationType),
                        ...
                        c.blocksOn.removeClass("cbp-item-off").each(function(b, d) {
                            ...
                            "sequentially" === c.options.animationType && (e.wrapper[0].style[f.private.animationDelay] = 60 * b + "ms")
                        }),
            ...
            c.sortBlocks(e, "top"),
                ...
                requestAnimationFrame(function() {
                    ...
                    var d = c.blocksOn.length
                        , g = e.length;
                    0 === d && 0 === g ? b() : d < g ? e.last().children(".cbp-item-wrapper").one(f.private.animationend, b) : c.blocksOn.last().data("cbp").wrapper.one(f.private.animationend, b),
                        c.resizeMainContainer()
                })
        }
            ,
    ...
    function(a, b, c, d) {
        ...
        function e(a) {
            ...
            b.parent = a,
                ...
                a.registerEvent("onMediaQueries", function(a) {
                    a && a.hasOwnProperty("caption") ? b.captionOn !== a.caption && (b.destroy(),
                        b.captionOn = a.caption,
                        b.init()) : b.captionOn !== c.caption && (b.destroy(),
                        b.captionOn = c.caption,
                        b.init())
                }),
                b.init()
        ...
        e.prototype.init = function() {
            var a = this;
            "" != a.captionOn && ("expand" === a.captionOn || f.private.modernBrowser || (a.parent.options.caption = a.captionOn = "minimal"),
                a.parent.$obj.addClass("cbp-caption-active cbp-caption-" + a.captionOn))
        }
            ,
            e.prototype.destroy = function() {
    ...
    function(a, b, c, d) {
        ...
        function e(b) {
            var c = this;
            c.parent = b,
                b.registerEvent("initFinish", function() {
                    b.$obj.on("click.cbp", ".cbp-caption-defaultWrap", function(c) {
                        if (c.preventDefault(),
                            ...
                            if (b.$obj.addClass("cbp-caption-expand-active"),
                            ...
                            e.css(g),
                                b.$obj.one("pluginResize.cbp", function() {
                                    ...
                                    0 === g.height && (f.removeClass("cbp-caption-expand-open"),
                                        e.attr("style", ""))
                                }),
        ...
        function e(b) {
            b.registerEvent("initEndWrite", function() {
                if (!(b.width <= 0)) {
                    var c = a.Deferred();
                    b.pushQueue("delayFrame", c),
                        b.obj.style[f.private.animationDuration] = b.options.displayTypeSpeed + "ms",
    ...
    function(a, b, c, d) {
                ...
                b.registerEvent("resetFiltersVisual", function() {
                    ...
                    c.filters.each(function(b, c) {
                        ...
                        a.each(d, function(a, b) {
                            ...
                            if (c.length)
                                return c.addClass("cbp-filter-item-active").siblings().removeClass("cbp-filter-item-active"),
                                    d.splice(a, 1),
                                    !1
                        })
                    }),
        ...
        e.prototype.registerFilter = function() {
            ...
            b.wrap = b.filters.find(".cbp-l-filters-dropdownWrap").on({
                ...
                b.filters.each(function(e, f) {
                    var g = a(f)
                        ...
                        , j = {};
                    g.hasClass("cbp-l-filters-dropdown") && (j.wrap = g.find(".cbp-l-filters-dropdownWrap"),
            ...
            e.prototype.filtersCallback = function(b, c) {
                a.isEmptyObject(b) || (b.wrap.trigger("mouseleave.cbp"),
            ...
            e.prototype.destroy = function() {
                var a = this;
                a.filters.find(".cbp-filter-item").off(".cbp"),
                    a.wrap.off(".cbp")
            }
            ,
    ...
    function(a, b, c, d) {
        ...
        function e(b) {
            ...
            b.registerEvent("onMediaQueries", function(e) {
                b.options.gapVertical = e && e.hasOwnProperty("gapVertical") ? e.gapVertical : c,
                    b.options.gapHorizontal = e && e.hasOwnProperty("gapHorizontal") ? e.gapHorizontal : d,
                    b.blocks.each(function(c, d) {
                        var e = a(d).data("cbp");
    ...
    function(a, b, c, d) {
        ...
        function f(a) {
            var b = this;
            a.hasClass("cbp-slider-inline-ready") || (a.addClass("cbp-slider-inline-ready"),
                ...
                a.find(".cbp-slider-next").on("click.cbp", function(a) {
                    a.preventDefault(),
                        b.active < b.total ? (b.active++,
                            b.updateLeft()) : b.active === b.total && (b.active = 0,
                            b.updateLeft())
                }),
                a.find(".cbp-slider-prev").on("click.cbp", function(a) {
                    a.preventDefault(),
                        b.active > 0 ? (b.active--,
                            b.updateLeft()) : 0 === b.active && (b.active = b.total,
                            b.updateLeft())
                }))
        }
        var g = {}
    ...
    function(a, b, c, d) {
        ...
        var f = {
            ...
            , h = a(b);
        g.private.lazyLoadScroll = new g.private.publicEvents("scroll.cbplazyLoad",50),
            e.prototype.loadImages = function() {
                var b = this
                    , c = b.parent.$obj.find("img").filter("[data-cbp-src]");
                0 !== c.length && (b.screenHeight = h.height(),
                    c.each(function(c, d) {
                        ...
                        null === b.parent.checkSrc(a("<img>").attr("src", f)) ? (b.removeLazyLoad(d, f),
                            e.removeClass(b.options.loadingClass)) : (e.addClass(b.options.loadingClass),
    ...
    function(a, b, c, d) {
        ...
        function e(b) {
            ...
            0 !== c.loadMore.length && (c.loadItems = c.loadMore.find(".cbp-l-loadMore-loadItems"),
            "0" === c.loadItems.text() && c.loadMore.addClass("cbp-l-loadMore-stop"),
                b.registerEvent("filterStart", function(a) {
                    c.populateItems().then(function() {
                        var b = c.items.filter(a).length;
                        b > 0 ? (c.loadMore.removeClass("cbp-l-loadMore-stop"),
                            c.loadItems.html(b)) : c.loadMore.addClass("cbp-l-loadMore-stop")
                    })
                }),
                c[c.options.action]())
        }
        ...
        e.prototype.populateItems = function() {
            var b = this;
            return b.items ? a.Deferred().resolve() : (b.items = a(),
                a.ajax({
            ...
            e.prototype.populateInsertItems = function(b) {
                ...
                return c.items.each(function(b, g) {
                    return f !== c.options.loadItems && void (e && "*" !== e ? a(g).filter(e).length && (d.push(g),
                        c.items[b] = null,
                        f++) : (d.push(g),
                        c.items[b] = null,
                        f++))
            ...
            e.prototype.click = function() {
                function a() {
                    ...
                    a = c && "*" !== c ? b.items.filter(c).length : b.items.length,
                        0 === a ? b.loadMore.addClass("cbp-l-loadMore-stop") : b.loadItems.html(a)
                }
                var b = this;
                b.loadMore.on("click.cbp", function(c) {
                    c.preventDefault(),
                    b.parent.isAnimating || b.loadMore.hasClass("cbp-l-loadMore-stop") || (b.loadMore.addClass("cbp-l-loadMore-loading"),
            ...
            e.prototype.auto = function() {
                ...
                function d() {
                    ...
                    a = b && "*" !== b ? e.items.filter(b).length : e.items.length,
                        0 === a ? e.loadMore.removeClass("cbp-l-loadMore-loading").addClass("cbp-l-loadMore-stop") : (e.loadItems.html(a),
                            f.trigger("scroll.loadMore")),
                        h = !1,
                    0 === e.items.length && (g.private.loadMoreScroll.destroyEvent(e),
                        e.parent.$obj.off("filterComplete.cbp"))
                }
                var e = this
                    , f = a(b)
                    , h = !1;
                g.private.loadMoreScroll = new g.private.publicEvents("scroll.loadMore",100),
            ...
            e.prototype.destroy = function() {
                ...
                g.private.loadMoreScroll && g.private.loadMoreScroll.destroyEvent(this)
            }
            ,
            g.plugins.loadMore = function(a) {
                var b = a.options.plugins;
                return a.options.loadMore && (b.loadMore || (b.loadMore = {}),
                    b.loadMore.element = a.options.loadMore),
                a.options.loadMoreAction && (b.loadMore || (b.loadMore = {}),
                    b.loadMore.action = a.options.loadMoreAction),
                b.loadMore && b.loadMore.selector !== d && (b.loadMore.element = b.loadMore.selector,
    ...
    function(a, b, c, d) {
        ...
        var f = a.fn.cubeportfolio.constructor
            ...
            init: function(b, d) {
                var e, f = this;
                if (f.cubeportfolio = b,
                    f.type = d,
                    f.isOpen = !1,
                    f.options = f.cubeportfolio.options,
                "lightbox" === d && (f.cubeportfolio.registerEvent("resizeWindow", function() {
                    f.resizeImage()
                }),
                    f.localOptions = a.extend({}, g, f.cubeportfolio.options.plugins.lightbox)),
                "singlePageInline" === d) {
                    if (f.height = 0,
                ...
                "singlePage" === d) {
                    if (f.cubeportfolio.registerEvent("resizeWindow", function() {
                        ...
                        if (a.each(h, function(b, c) {
                            ...
                            m.setAttribute("href", h[0]),
                                f.openSinglePage([m], m)
                        }
                    }
            ...
            createMarkup: function() {
                var b = this
                    , e = "";
                "singlePage" === b.type && "left" !== b.options.singlePageAnimation && (e = " cbp-popup-singlePage-" + b.options.singlePageAnimation),
                    b.wrap = a("<div/>", {
                    ...
                    "ios" === f.private.browser && b.contentWrap.css("overflow", "auto"),
                        b.content = a("<div/>", {
                ...
                "ie8" === f.private.browser && (b.bg = a("<div/>", {
                    ...
                    "singlePage" === b.type && b.options.singlePageStickyNavigation === !1 ? b.navigationWrap = a("<div/>", {
                ...
                "singlePage" === b.type && (b.options.singlePageCounter && (b.counter = a(b.options.singlePageCounter).appendTo(b.navigation),
                    b.counter.text("")),
                    b.content.on("click.cbp", b.options.singlePageDelegate, function(a) {
                        a.preventDefault();
                        var e, f, g = b.dataArray.length, h = this.getAttribute("href");
                        for (e = 0; e < g; e++)
                        ...
                        if (f === d) {
                            ...
                            b.singlePageJumpTo(f - b.current)
                    }),
                    b.contentWrap.on("mousewheel.cbp DOMMouseScroll.cbp", function(a) {
                        a.stopImmediatePropagation()
                    })),
                    a(c).on("keydown.cbp", function(a) {
                        b.isOpen && (b.stopEvents || (i && a.stopImmediatePropagation(),
                            37 === a.keyCode ? b.prev() : 39 === a.keyCode ? b.next() : 27 === a.keyCode && b.close()))
                    })
            },
            ...
            destroy: function() {
                ...
                a(c).off("keydown.cbp"),
                    ...
                    b.cubeportfolio.$obj.off("click.cbp", b.options.singlePageInlineDelegate),
                    ...
                    b.cubeportfolio.$obj.find(".cbp-item").removeClass("cbp-singlePageInline-active"),
                    b.wrap.remove()
            },
            openLightbox: function(d, e) {
                var f, g, h = this, j = 0, k = [];
                if (!h.isOpen) {
                    if (i = !0,
                        h.isOpen = !0,
                        h.stopEvents = !1,
                    ...
                    a.each(d, function(b, c) {
                        var d, e = c.getAttribute("href"), g = e, i = "isImage";
                        if (a.inArray(e, k) === -1) {
                            if (f === e)
                                h.current = j;
                            else if (!h.options.lightboxGallery)
                                return;
                            if (/youtu\.?be/i.test(e)) {
                                ...
                                /vimeo\.com/i.test(e) ? (d = e.substring(e.lastIndexOf("/") + 1),
                                /autoplay=/i.test(d) || (d += "&autoplay=1"),
                                    d = d.replace(/\?|&/, "?"),
                                    g = "//player.vimeo.com/video/" + d,
                                    i = "isVimeo") : /www\.ted\.com/i.test(e) ? (g = "http://embed.ted.com/talks/" + e.substring(e.lastIndexOf("/") + 1) + ".html",
                                    i = "isTed") : /soundcloud\.com/i.test(e) ? (g = e,
                                    i = "isSoundCloud") : /(\.mp4)|(\.ogg)|(\.ogv)|(\.webm)/i.test(e) ? (g = e.indexOf("|") !== -1 ? e.split("|") : e.split("%7C"),
                                    i = "isSelfHostedVideo") : /\.mp3$/i.test(e) && (g = e,
                                    i = "isSelfHostedAudio");
                            h.dataArray.push({
                                src: g,
                        ...
                        1 === h.counterTotal ? (h.nextButton.hide(),
                            h.prevButton.hide(),
                            h.dataActionImg = "") : (h.nextButton.show(),
                            h.prevButton.show(),
            ...
            openSinglePage: function(d, e) {
                var g, h = this, i = 0, j = [];
                if (!h.isOpen) {
                    if (h.cubeportfolio.singlePageInline && h.cubeportfolio.singlePageInline.isOpen && h.cubeportfolio.singlePageInline.close(),
                        h.isOpen = !0,
                        h.stopEvents = !1,
                        h.dataArray = [],
                        h.current = null,
                    ...
                    if (a.each(d, function(b, c) {
                        ...
                        a.inArray(d, j) === -1 && (g === d && (h.current = i),
                            h.dataArray.push({
                                url: d,
                                element: c
                            }),
                        ...
                        h.counterTotal = h.dataArray.length,
                        1 === h.counterTotal ? (h.nextButton.hide(),
                            h.prevButton.hide()) : (h.nextButton.show(),
                            h.prevButton.show()),
                        h.wrap.appendTo(c.body),
                        h.scrollTop = a(b).scrollTop(),
                        ...
                        h.wrap.one(f.private.transitionend, function() {
                            a("html").css({
                                ...
                                h.wrap.addClass("cbp-popup-transitionend"),
                            h.options.singlePageStickyNavigation && (h.wrap.addClass("cbp-popup-singlePage-sticky"),
                    ...
                    "ie8" !== f.private.browser && "ie9" !== f.private.browser || (a("html").css({
                        ...
                        h.wrap.addClass("cbp-popup-transitionend"),
                    h.options.singlePageStickyNavigation && (h.navigationWrap.width(h.contentWrap[0].clientWidth),
                        setTimeout(function() {
                    ...
                    h.options.singlePageDeeplinking && (h.url = h.url.split("#cbp=")[0],
            ...
            openSinglePageInline: function(c, d, e) {
                ...
                if (e = e || !1,
                    ...
                    j.isOpen)
                    return g = j.cubeportfolio.blocksOn.index(a(d).closest(".cbp-item")),
                        void (j.dataArray[j.current].url !== d.getAttribute("href") || j.current !== g ? j.cubeportfolio.singlePageInline.close("open", {
                            blocks: c,
                            currentBlock: d,
                            fromOpen: !0
                        }) : j.close());
                ...
                if (h = a(d).closest(".cbp-item")[0],
                    ...
                    i = a(j.dataArray[j.current].element).parents(".cbp-item").addClass("cbp-singlePageInline-active"),
                    ...
                    j.top = l,
                        ...
                        c.each(function(b, c) {
                            var d = a(c)
                                , e = d.data("cbp").top
                                , f = e + d.height();
                            f <= l || (e >= l && (j.blocksToMove = j.blocksToMove.add(c)),
                            e < l && f > l && (j.top = f + j.options.gapHorizontal,
                            f - l > j.topDifference && (j.topDifference = f - l + j.options.gapHorizontal)))
                        }),
                    ...
                    j.top = m,
                        ...
                        c.each(function(b, c) {
                            var d = a(c)
                                ...
                                , g = f + e;
                            if (!(g <= m))
                                return f >= m - e / 2 ? void (j.blocksToMove = j.blocksToMove.add(c)) : void (g > m && f < m && (g > j.top && (j.top = g),
                ...
                if (j.wrap[0].style.height = j.wrap.outerHeight(!0) + "px",
                    ...
                    j.scrollTop !== n ? a("html,body").animate({
                        ...
                        j.resizeSinglePageInline(),
                            j.deferredInline.resolve()
                    }) : (j.resizeSinglePageInline(),
                        j.deferredInline.resolve())
                } else
                    j.resizeSinglePageInline(),
                ...
                j.options.singlePageInlineDeeplinking && (j.url = j.url.split("#cbpi=")[0],
            ...
            resizeSinglePageInline: function() {
                var a = this;
                a.height = 0 === a.top || a.top === a.cubeportfolio.height ? a.wrap.outerHeight(!0) : a.wrap.outerHeight(!0) - a.options.gapHorizontal,
                ...
                var b = this
                    ...
                    g.type = "text/javascript",
                        g.readyState ? g.onreadystatechange = function() {
                                "loaded" != g.readyState && "complete" != g.readyState || (g.onreadystatechange = null,
                                    d++,
                                a[d] && e(a[d]))
                            }
                            : g.onload = function() {
            ...
            updateSinglePage: function(b, c, d) {
                var e, f = this;
                f.content.addClass("cbp-popup-content").removeClass("cbp-popup-content-basic"),
                d === !1 && f.content.removeClass("cbp-popup-content").addClass("cbp-popup-content-basic"),
                f.counter && (e = a(f.getCounterMarkup(f.options.singlePageCounter, f.current + 1, f.counterTotal)),
            ...
            updateSinglePageIsOpen: function() {
                ...
                b.fromAJAX.scripts && b.appendScriptsToWrap(b.fromAJAX.scripts),
                    ...
                    a.length ? (a.find(".cbp-slider-item").addClass("cbp-item"),
            ...
            createPinterestShare: function(a) {
                if (a.length && !a.attr("onclick")) {
                    ...
                    d && (c = d.src),
                        a.attr("onclick", "window.open('http://pinterest.com/pin/create/button/?url=" + encodeURIComponent(b.location.href) + "&media=" + c + "', '_blank', 'top=100,left=100,toolbar=0,status=0,width=620,height=400'); return false;")
                }
            },
            updateSinglePageInline: function(a, b) {
                ...
                b && c.appendScriptsToWrap(b),
                    ...
                    0 !== c.localOptions.delay ? setTimeout(function() {
            ...
            singlePageInlineIsOpen: function() {
                ...
                b.cubeportfolio.loadImages(b.wrap, function() {
                    ...
                    c.length ? (c.find(".cbp-slider-item").addClass("cbp-item"),
            ...
            isImage: function(b) {
                ...
                new Image;
                c.tooggleLoading(!0),
                    c.cubeportfolio.loadImages(a('<div><img src="' + b.src + '"></div>'), function() {
            ...
            singlePageJumpTo: function(b) {
                ...
                c.slider && f.private.resize.destroyEvent(a.data(c.slider[0], "cubeportfolio")),
                    c.options.singlePageCallback.call(c, c.dataArray[c.current].url, c.dataArray[c.current].element),
                c.options.singlePageDeeplinking && (location.href = c.url + "#cbp=" + c.dataArray[c.current].url))
            },
            resetWrap: function() {
                var a = this;
                "singlePage" === a.type && a.options.singlePageDeeplinking && (location.href = a.url + "#"),
                "singlePageInline" === a.type && a.options.singlePageInlineDeeplinking && (location.href = a.url + "#")
            },
            getIndex: function(a) {
                var b = this;
                return a %= b.counterTotal,
                a < 0 && (a = b.counterTotal + a),
                    a
            },
            close: function(c, d) {
                function e() {
                    h.slider && f.private.resize.destroyEvent(a.data(h.slider[0], "cubeportfolio")),
                        h.content.html(""),
                        h.wrap.detach(),
                        h.cubeportfolio.$obj.removeClass("cbp-popup-singlePageInline-open cbp-popup-singlePageInline-close"),
                    "promise" === c && a.isFunction(d.callback) && d.callback.call(h.cubeportfolio)
                }
                function g() {
                    var d = a(b).scrollTop();
                    h.resetWrap(),
                ...
                var h = this;
                h.isOpen = !1,
                    "singlePageInline" === h.type ? "open" === c ? (h.wrap.removeClass("cbp-popup-singlePageInline-ready"),
                        a(h.dataArray[h.current].element).closest(".cbp-item").removeClass("cbp-singlePageInline-active"),
                        h.openSinglePageInline(d.blocks, d.currentBlock, d.fromOpen)) : (h.height = 0,
                        h.revertResizeSinglePageInline(),
                        h.wrap.removeClass("cbp-popup-singlePageInline-ready"),
                        h.cubeportfolio.$obj.addClass("cbp-popup-singlePageInline-close"),
                        h.cubeportfolio.$obj.find(".cbp-item").removeClass("cbp-singlePageInline-active"),
                        f.private.modernBrowser ? h.wrap.one(f.private.transitionend, function() {
                            g()
                        }) : g()) : "singlePage" === h.type ? (h.resetWrap(),
                        a(b).scrollTop(h.scrollTop),
                        h.stopScroll = !0,
                        h.wrap.removeClass("cbp-popup-ready cbp-popup-transitionend cbp-popup-singlePage-open cbp-popup-singlePage-sticky"),
                        a("html").css({
                            overflow: "",
                            marginRight: "",
                            position: ""
                        }),
                    "ie8" !== f.private.browser && "ie9" !== f.private.browser || (h.slider && f.private.resize.destroyEvent(a.data(h.slider[0], "cubeportfolio")),
                        h.content.html(""),
                        h.wrap.detach()),
                        h.wrap.one(f.private.transitionend, function() {
                            h.slider && f.private.resize.destroyEvent(a.data(h.slider[0], "cubeportfolio")),
            ...
            preloadNearbyImages: function() {
                for (var a = this, b = [a.getIndex(a.current + 1), a.getIndex(a.current + 2), a.getIndex(a.current + 3), a.getIndex(a.current - 1), a.getIndex(a.current - 2), a.getIndex(a.current - 3)], c = b.length - 1; c >= 0; c--)
                    "isImage" === a.dataArray[b[c]].type && a.cubeportfolio.checkSrc(a.dataArray[b[c]])
            }
        }
            , i = !1
            , j = !1
        ...
        e.prototype.run = function() {
            var b = this
                ...
                , e = a(c.body);
            d.lightbox = null,
            d.options.lightboxDelegate && !j && (j = !0,
                ...
                d.singlePage = null,
            d.options.singlePageDelegate && !k && (k = !0,
            ...
            d.options.singlePageInlineDelegate && (d.singlePageInline = Object.create(h),
                d.singlePageInline.init(d, "singlePageInline"),
                d.$obj.on("click.cbp", d.options.singlePageInlineDelegate, function(b) {
                    b.preventDefault();
            ...
            e.prototype.detectScope = function(b) {
                var d, e, f;
                return d = b.closest(".cbp-popup-singlePageInline"),
                    d.length ? (f = b.closest(".cbp", d[0]),
                        f.length ? f : d) : (e = b.closest(".cbp-popup-singlePage"),
                        e.length ? (f = b.closest(".cbp", e[0]),
                            f.length ? f : e) : (f = b.closest(".cbp"),
                            f.length ? f : a(c.body)))
            }
            ,
            e.prototype.destroy = function() {
    ...
    function(a, b, c, d) {
        ...
        function e(b) {
            ...
            c.searchInput.on("keyup.cbp paste.cbp", function(b) {
                ...
                c.searchNothing = c.searchInput.siblings(".cbp-search-nothing").detach(),
                c.searchNothingHeight = null,
                c.searchNothingHTML = c.searchNothing.html(),
                c.searchInput.siblings(".cbp-search-icon").on("click.cbp", function(b) {
                    b.preventDefault(),
                        c.runEvent.call(c, a(this).prev().val(""))
                })
        }
        var f = a.fn.cubeportfolio.constructor;
        e.prototype.runEvent = function(b) {
            var c = this
                ...
                , e = b.data("searchData")
                , f = new RegExp(d,"i");
            e.value === d || c.parent.isAnimating || (e.value = d,
                d.length > 0 ? b.attr("value", d) : b.removeAttr("value"),
                c.parent.$obj.cubeportfolio("filter", function(b) {
                    ...
                    if (0 === g.length && c.searchNothing.length) {
                        ...
                        null === c.searchNothingHeight && (c.searchNothingHeight = c.searchNothing.outerHeight(!0)),
                            c.parent.registerEvent("resizeMainContainer", function() {
                                c.parent.height = c.parent.height + c.searchNothingHeight,
                                    c.parent.obj.style.height = c.parent.height + "px"
                            }, !0)
                    } else
                        c.searchNothing.detach();
                    return c.parent.triggerEvent("resetFiltersVisual"),
                        g
                }, function() {
                    b.trigger("keyup.cbp")
                }))
    ...
    function(a, b, c, d) {
        ...
        e.prototype.sliderMarkup = function() {
            ...
            b.options.showPagination && (b.navPagination = a("<div/>", {
                class: "cbp-nav-pagination"
            }).appendTo(b.nav)),
            (b.controls || b.navPagination) && b.nav.appendTo(b.$obj),
                b.updateSliderPagination(),
            b.options.auto && (b.options.autoPauseOnHover && (b.mouseIsEntered = !1,
                b.$obj.on("mouseenter.cbp", function(a) {
                    b.mouseIsEntered = !0,
                        b.stopSliderAuto()
            ...
            e.prototype.updateSlider = function() {
                var a = this;
                a.updateSliderPosition(),
                    a.updateSliderPagination()
            }
            ,
            e.prototype.destroy = function() {
                var a = this;
                a.parent.customPaginationItems && a.parent.customPaginationItems.off(".cbp"),
                (a.parent.controls || a.parent.navPagination) && (a.parent.nav.off(".cbp"),
                    a.parent.nav.remove())
            }
            ,
        ...
        o.prototype.css = function(i, e, o) {
            ...
            if (!n)
                for (var a = 0, r = this.vendors.length; r > a; a++)
                    if (n = null !== this.vendors[a] ? t.camelCase(this.vendors[a][1] + "-" + e) : e,
                    i.style[n] !== s) {
        ...
        c.fn.dzsparallaxer = function(a) {
            ...
            this.each(function() {
                function l() {
                    ...
                    0 < b.find(".divimage").length || 0 < b.find("img").length ? (d = b.children(".divimage, img").eq(0),
                        d.attr("data-src") ? (V = d.attr("data-src"),
                ...
                function S() {
                    if (!J) {
                        ...
                        b.hasClass("simple-parallax") ? (h.wrap('<div class="simple-parallax-inner"></div>'),
                        ...
                        if (b.hasClass("use-loading")) {
                            if (0 < b.find(".divimage").length || 0 < b.children("img").length) {
                                if (0 < b.find(".divimage").length) {
                                    ...
                                    void 0 == d && (d = String(b.find(".divimage").eq(0).css("background-image")).split("url(")[1],
                                        d = String(d).split(")")[0]);
                                    var f = new Image;
                                    f.onload = function(a) {
                                        b.addClass("loaded")
                        ...
                        if ("scroll" == a.settings_mode || "oneelement" == a.settings_mode)
                            c(window).unbind("scroll", n),
                                ...
                                n(),
                                setTimeout(n, 1E3),
                            document && document.addEventListener && document.addEventListener("touchmove", X, !1);
                ...
                function fa() {
                    ...
                    0 == b.hasClass("allbody") && 0 == b.hasClass("dzsparallaxer---window-height") && 0 == I && (k <= U && 0 < k ? ("oneelement" != a.settings_mode && 0 == b.hasClass("do-not-set-js-height") && 0 == b.hasClass("height-is-based-on-content") && b.height(k),
                        g = b.height(),
                        is_ie() && 10 >= version_ie() ? h.css("top", "0") : h.css("transform", "translate3d(0,0px,0)"),
                    G && G.css("opacity", "0")) : (console.info(b.hasClass("do-not-set-js-height")),
                    "oneelement" != a.settings_mode && 0 == b.hasClass("do-not-set-js-height") && 0 == b.hasClass("height-is-based-on-content") && b.height(U)));
                    h.attr("data-forcewidth_ratio") && (h.width(Number(h.attr("data-forcewidth_ratio")) * h.height()),
                ...
                function X(b) {
                    ...
                    "on" == a.settings_movexaftermouse && (b = b.pageX / Z * (z - H),
                    0 < b && (b = 0),
                    b < z - H && (b = z - H),
                        ia = b)
                }
                function n(l, f) {
                    ...
                    if (0 != k && !1 !== J && ("scroll" == a.settings_mode || "oneelement" == a.settings_mode)) {
                        ...
                        if ("scroll" == a.settings_mode) {
                            "fromtop" == a.mode_scroll && (p = d / g * (g - k),
                            "on" == a.is_fullscreen && (p = d / (c("body").height() - m) * (g - k),
                            u && (p = d / (u.height() - m) * (g - k))),
                            "reverse" == a.direction && (p = (1 - d / g) * (g - k),
                            "on" == a.is_fullscreen && (p = (1 - d / (c("body").height() - m)) * (g - k),
                            u && (p = (1 - d / (u.height() - m)) * (g - k)))));
                            v = b.offset().top;
                            u && (v = -parseInt(u.css("top"), 10));
                            e = (d - (v - m)) / (v + g - (v - m));
                            "on" == a.is_fullscreen && (e = d / (c("body").height() - m),
                            ...
                            "normal" == a.mode_scroll && (p = e * (g - k),
                            "reverse" == a.direction && (p = (1 - e) * (g - k)),
                            b.hasClass("debug-target") && console.info(a.mode_scroll, d, v, m, g, v + g, e));
                            b.hasClass("simple-parallax") && (e = (d + m - v) / (m + k),
                            0 > e && (e = 0),
                            1 < e && (e = 1),
                                e = Math.abs(1 - e),
                                p = 2 * e * x - x);
                            T && (e = Math.abs((d - v) / b.outerHeight() - 1),
                            1 < e && (e = 1),
                            0 > e && (e = 0),
                                T.css("opacity", e));
                            A = d / g;
                            0 == b.hasClass("simple-parallax") && (0 < p && (p = 0),
                            p < g - k && (p = g - k));
                            1 < A && (A = 1);
                            0 > A && (A = 0);
                            ...
                            ja = A;
                            0 === y && (q = L,
                            0 == D && (b.hasClass("simple-parallax") ? h.parent().hasClass("is-image") && h.css("background-position-y", "calc(50% - " + parseInt(q, 10) + "px)") : is_ie() && 10 >= version_ie() ? h.css("top", "" + q + "px") : (h.css("transform", "translate3d(" + E + "px," + q + "px,0)"),
                            "oneelement" == a.settings_mode && b.css("transform", "translate3d(" + E + "px," + q + "px,0)"))))
                        }
                    }
                }
                function K() {
                    if (D)
                        return requestAnimFrame(K),
                            !1;
                    isNaN(q) && (q = 0);
                    Y && (Y = !1);
                    if (0 === y)
                    ...
                    N = O;
                    R = ja - N;
                    "easeIn" == a.easing && (q = Number(Math.easeIn(1, M, Q, y).toFixed(5)),
                        O = Number(Math.easeIn(1, N, R, y).toFixed(5)));
                    "easeOutQuad" == a.easing && (q = Math.easeOutQuad(1, M, Q, y),
                        O = Math.easeOutQuad(1, N, R, y));
                    "easeInOutSine" == a.easing && (q = Math.easeInOutSine(1, M, Q, y),
                        O = Math.easeInOutSine(1, N, R, y));
                    E = 0;
                    "on" == a.settings_movexaftermouse && (ba = E,
                        ka = ia - ba,
                        E = Math.easeIn(1, ba, ka, y));
                    b.hasClass("simple-parallax") ? h.parent().hasClass("is-image") && h.css("background-position-y", "calc(50% - " + parseInt(q, 10) + "px)") : is_ie() && 10 >= version_ie() ? h.css("top", "" + q + "px") : (h.css("transform", "translate3d(" + E + "px," + q + "px,0)"),
                    "oneelement" == a.settings_mode && b.css("transform", "translate3d(" + E + "px," + q + "px,0)"));
                    G && G.css("opacity", O);
                    t && t(q);
                    if (ga)
...
function is_ie() {
    var c = window.navigator.userAgent
        , a = c.indexOf("MSIE ");
    if (0 < a)
        return parseInt(c.substring(a + 5, c.indexOf(".", a)), 10);
    if (0 < c.indexOf("Trident/"))
        return a = c.indexOf("rv:"),
    ...
    e.prototype = {
        ...
        getPositions: function() {
            ...
            e.$nav.each(function() {
                n = e.getHash(t(this)),
                    s = t("#" + n),
                s.length && (i = s.offset().top,
                    e.sections[n] = Math.round(i))
            })
        },
        ...
        scrollChange: function() {
            ...
            null !== i && (t = this.$elem.find('a[href$="#' + i + '"]').parent(),
...
!function(t) {
        ...
        unstick: function(e) {
            return this.each(function() {
                for (var e = this, n = t(e), r = -1, s = o.length; s-- > 0; )
                    o[s].stickyElement.get(0) === e && (i.call(o, s, 1),
                        r = s);
                -1 !== r && (n.unwrap(),
                    n.css({
                        width: "",
    ...
    window.addEventListener ? (window.addEventListener("scroll", c, !1),
        window.addEventListener("resize", p, !1)) : window.attachEvent && (window.attachEvent("onscroll", c),
        ...
        _goto: function(s) {
            ...
            this.support.transition || e.css("display", "none"),
                ...
                h.css("transition", "all 0ms").each(function() {
                    ...
                    y && (this.className += " vegas-transition-" + y,
...
!function(jQuery, ytp) {
    jQuery.mbYTPlayer = {
        ...
        buildPlayer: function(options) {
            return this.each(function() {
                ...
                !YTPlayer.isBackground || !ytp.backgroundIsInited) {
                    ...
                    jQuery.isTablet && jQuery("body").one("touchstart", function() {
                    ...
                    if (console.debug(jQuery.mbBrowser.mobile, jQuery.isTablet, YTPlayer.canPlayOnMobile),
                    jQuery.mbBrowser.mobile && !jQuery.isTablet && !YTPlayer.canPlayOnMobile)
                        ...
                        YTPlayer.isBackground && ytp.backgroundIsInited || YTPlayer.isInit || (YTPlayer.isBackground && (ytp.backgroundIsInited = !0),
                            ...
                            jQuery(YTPlayer).on("YTPChanged", function() {
                                if (!YTPlayer.isInit) {
                                    ...
                                    jQuery.mbBrowser.mobile && YTPlayer.canPlayOnMobile && !jQuery.isTablet) {
        ...
        getDataFromAPI: function(a) {
            ...
            !a.isPlayer || a.opt.autoPlay || jQuery.mbBrowser.mobile || jQuery.isTablet || (a.loading = jQuery("<div/>").addClass("loading").html("Loading").hide(),
...
!function(a) {
    ...
    function b(a, b, c) {
        if (a && c.style.filter) {
            ...
            !a && b._filter && (c.style.filter = b._filter)
    }
